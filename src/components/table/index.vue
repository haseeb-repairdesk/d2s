<template>
  <div class="dd-flow-root">
    <div class="dd-min-w-full dd-align-middle">
      <div :class="[noHeight ? '' : 'dd-max-h-[calc(30vh-80px)] dd-min-h-[calc(100vh-80px)]']" class="fixedScroll">
        <!-- header with group button  -->
        <div class="dd-flex dd-items-center dd-justify-between dd-sticky dd-top-0">
          ...
          <transition name="thead">
            <thead class="dd-cursor-pointer !dd-sticky !dd-top-0 dd-bg-white dd-z-[1000]" v-if="selectedId.length == 0 && !search">
              <tr>
                ...
                <th class="dd-flex dd-items-center dd-justify-end dd-gap-8 dd-mr-6">
                  ...
                  <transition name="setting">
                    <div v-if="setting"
                      ...
                      <div class="dd-flex dd-items-center dd-justify-between dd-gap-2 dd-font-sans"
                        ...
                        <div class="dd-w-16">
                          <dd-input v-mask="'#'" v-model="col.size" type="number" :disabled="col.disabled"
...
.custom-scrollbar {
  ...
  scrollbar-color: #e1dede #f1f1f1 !important;
}
